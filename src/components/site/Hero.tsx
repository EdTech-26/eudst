      ...
      <div className="container relative grid gap-12 py-20 md:py-28 lg:grid-cols-12 lg:gap-10 lg:py-32">
        <div className="lg:col-span-7">
          ...
          <motion.h1
            ...
            className="mt-6 font-display text-5xl font-semibold leading-[1.05] tracking-tight text-ink text-balance md:text-6xl lg:text-7xl"
          >
            Applied online learning,{" "}
            <span className="italic text-primary">built for the way you work.</span>
          </motion.h1>
